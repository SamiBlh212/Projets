...
void loop()
{
  ...
  float val1 = map(potentiometerValueA0, 0, 1023, 0, 10);
  float val2 = map(potentiometerValueA1, 0, 1023, 0, 10);
  float val3 = map(potentiometerValueA2, 0, 1023, 0, 10);
...
///////////////////////   LAMPADAIRES 1/3   /////////////////////////////
        ...
        case 'A': // Allumage lampadaires 1/3
          Serial.println("Reception : ");
          //Serial.println(client.read());
          digitalWrite(pin1, LOW);
          Serial.println("Allumage lampadaires 1/3");
          break;  

        case 'B': // éteindre lampadaires 1/3
          digitalWrite(pin1, HIGH);
          Serial.println("Eteindre lampadaires 1/3");
          break;
          
//////////////////////////////////////////////////////////////////////////  
///////////////////////   LAMPADAIRES 2/3   /////////////////////////////

        case 'C': // Allumage lampadaires 2/3
          digitalWrite(pin2, LOW);
          Serial.println("Allumage lampadaires 2/3");
          break;
           
        case 'D': // éteindre lampadaires 2/3
          digitalWrite(pin2, HIGH);
          Serial.println("Eteindre lampadaires 2/3");
          break;
          
//////////////////////////////////////////////////////////////////////////  
///////////////////////   LAMPADAIRES 3/3   /////////////////////////////

        case 'E': // Allumage lampadaires 3/3
          digitalWrite(pin3, LOW);
          Serial.println("Allumage lampadaires 3/3");
          break;
